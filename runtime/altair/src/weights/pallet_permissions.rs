...
impl<T: frame_system::Config> pallet_permissions::WeightInfo for WeightInfo<T> {
	...
	fn add_as_admin() -> Weight {
		...
		//  Measured:  `3`
		//  Estimated: `5224`
		// Minimum execution time: 20_407 nanoseconds.
		Weight::from_parts(20_909_000, 5224)
	...
	fn add_as_editor() -> Weight {
		...
		Weight::from_parts(28_774_000, 7927)
	...
	fn remove_as_admin() -> Weight {
		...
		Weight::from_parts(24_836_000, 5224)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: Permissions Permission (r:2 w:1)
	...
	fn remove_as_editor() -> Weight {
		...
		Weight::from_parts(30_757_000, 7927)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: Permissions Permission (r:1 w:1)
	...
	fn purge() -> Weight {
		...
		//  Measured:  `146`
		//  Estimated: `2703`
		// Minimum execution time: 20_569 nanoseconds.
		Weight::from_parts(21_130_000, 2703)
	...
	fn admin_purge() -> Weight {
		...
		Weight::from_parts(21_630_000, 2703)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

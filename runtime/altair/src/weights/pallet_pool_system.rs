...
impl<T: frame_system::Config> pallet_pool_system::WeightInfo for WeightInfo<T> {
	...
	fn close_epoch_no_orders(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(32_998_422 as u64)
			// Standard Error: 58_083
			.saturating_add(Weight::from_ref_time(54_257_768 as u64).saturating_mul(n as u64))
	...
	fn close_epoch_no_execution(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(38_434_754 as u64)
			// Standard Error: 78_629
			.saturating_add(Weight::from_ref_time(23_591_764 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(4 as u64))
	...
	fn close_epoch_execute(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(94_089_602 as u64)
			// Standard Error: 133_828
			.saturating_add(Weight::from_ref_time(56_593_808 as u64).saturating_mul(n as u64))
	...
	fn submit_solution(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(23_533_936 as u64)
			// Standard Error: 15_899
			.saturating_add(Weight::from_ref_time(1_114_310 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: PoolSystem EpochExecution (r:1 w:1)
	...
	fn execute_epoch(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(86_888_317 as u64)
			// Standard Error: 155_049
			.saturating_add(Weight::from_ref_time(40_314_953 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(8 as u64))
			.saturating_add(T::DbWeight::get().reads((7 as u64).saturating_mul(n as u64)))

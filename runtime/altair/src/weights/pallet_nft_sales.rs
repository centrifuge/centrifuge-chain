...
impl<T: frame_system::Config> pallet_nft_sales::WeightInfo for WeightInfo<T> {
	...
	fn add() -> Weight {
		...
		//  Measured:  `688`
		//  Estimated: `7874`
		// Minimum execution time: 57_648 nanoseconds.
		Weight::from_parts(58_770_000, 7874)
	...
	fn remove() -> Weight {
		...
		Weight::from_parts(57_598_000, 7874)
			.saturating_add(T::DbWeight::get().reads(3))
	...
	fn buy() -> Weight {
		...
		//  Measured:  `1377`
		//  Estimated: `15685`
		// Minimum execution time: 99_876 nanoseconds.
		Weight::from_parts(100_999_000, 15685)

...
impl<T: frame_system::Config> pallet_keystore::WeightInfo for WeightInfo<T> {
	...
	fn add_keys(n: u32, ) -> Weight {
		...
		Weight::from_parts(17_037_300, 3114)
			// Standard Error: 9_239
			.saturating_add(Weight::from_ref_time(21_787_207).saturating_mul(n.into()))
	...
	fn revoke_keys(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(10_823_281)
			// Standard Error: 13_776
			.saturating_add(Weight::from_ref_time(12_299_263).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
			.saturating_add(Weight::from_proof_size(2595).saturating_mul(n.into()))
	}

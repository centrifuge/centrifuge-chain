...
impl<T: frame_system::Config> pallet_pool_registry::WeightInfo for WeightInfo<T> {
	...
	fn register(n: u32, m: u32, ) -> Weight {
		...
		// Minimum execution time: 177_501_000 picoseconds.
		Weight::from_parts(103_832_524, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 83_949
			.saturating_add(Weight::from_parts(23_159_049, 0).saturating_mul(m.into()))
	...
	fn update(n: u32) -> Weight {
		...
		// Minimum execution time: 98_383_000 picoseconds.
		Weight::from_parts(66_520_894, 0)
			.saturating_add(Weight::from_parts(0, 17508))
	...
	fn execute_update(n: u32) -> Weight {
		...
		//  Estimated: `17508 + n * (3417 ±0)`
		// Minimum execution time: 90_619_000 picoseconds.
		Weight::from_parts(60_217_749, 0)
			.saturating_add(Weight::from_parts(0, 17508))

...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(4_736_081 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(210 as u64).saturating_mul(b as u64))
	}
	/// The range of component `b` is `[0, 3932160]`.
	fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(13_000_000 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(1_213 as u64).saturating_mul(b as u64))
	}
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(4_000_000 as u64)
			// Standard Error: 903
			.saturating_add(Weight::from_ref_time(748_529 as u64).saturating_mul(i as u64))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(4_000_000 as u64)
			// Standard Error: 840
			.saturating_add(Weight::from_ref_time(555_475 as u64).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(6_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(1_097_788 as u64).saturating_mul(p as u64))

...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	fn initialize() -> Weight {
		(25_139_000 as Weight).saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	fn set_vesting_start() -> Weight {
		(21_945_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn set_vesting_period() -> Weight {
		(22_174_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn set_direct_payout_ratio() -> Weight {
		(22_039_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
}

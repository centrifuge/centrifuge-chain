...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	fn initialize() -> Weight {
		Weight::from_ref_time(29_755_000).saturating_add(T::DbWeight::get().writes(3 as u64))
	}

	fn set_vesting_start() -> Weight {
		Weight::from_ref_time(26_883_000).saturating_add(T::DbWeight::get().writes(1 as u64))
	}

	fn set_vesting_period() -> Weight {
		Weight::from_ref_time(26_700_000).saturating_add(T::DbWeight::get().writes(1 as u64))
	}

	fn set_direct_payout_ratio() -> Weight {
		Weight::from_ref_time(26_720_000).saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}

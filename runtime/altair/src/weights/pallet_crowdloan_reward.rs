...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	fn initialize() -> Weight {
		(21_817_000 as Weight).saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	fn set_vesting_start() -> Weight {
		(18_943_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn set_vesting_period() -> Weight {
		(21_231_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn set_direct_payout_ratio() -> Weight {
		(22_193_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
}

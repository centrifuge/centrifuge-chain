...
impl<T: frame_system::Config> pallet_token_mux::WeightInfo for WeightInfo<T> {
	...
	fn deposit() -> Weight {
		...
		Weight::from_parts(125_617_000, 0)
	...
	fn burn() -> Weight {
		...
		//  Measured:  `1093`
		//  Estimated: `8802`
		// Minimum execution time: 110_277_000 picoseconds.
		Weight::from_parts(111_640_000, 0)
			.saturating_add(Weight::from_parts(0, 8802))
	...
	fn match_swap() -> Weight {
		...
		//  Measured:  `1373`
		//  Estimated: `11406`
		// Minimum execution time: 219_272_000 picoseconds.
		Weight::from_parts(221_907_000, 0)

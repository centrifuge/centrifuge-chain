...
impl<T: frame_system::Config> pallet_token_mux::WeightInfo for WeightInfo<T> {
	...
	fn deposit() -> Weight {
		...
		//  Measured:  `901`
		//  Estimated: `11406`
		// Minimum execution time: 212_538_000 picoseconds.
		Weight::from_parts(216_546_000, 0)
	...
	fn burn() -> Weight {
		...
		Weight::from_parts(210_595_000, 0)
			.saturating_add(Weight::from_parts(0, 11406))
			.saturating_add(T::DbWeight::get().reads(11))
	...
	fn match_swap() -> Weight {
		...
		//  Measured:  `1121`
		//  Estimated: `11406`
		// Minimum execution time: 181_310_000 picoseconds.
		Weight::from_parts(184_146_000, 0)
			.saturating_add(Weight::from_parts(0, 11406))
			.saturating_add(T::DbWeight::get().reads(11))

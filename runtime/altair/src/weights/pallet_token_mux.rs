...
impl<T: frame_system::Config> pallet_token_mux::WeightInfo for WeightInfo<T> {
	...
	fn deposit() -> Weight {
		...
		Weight::from_parts(100_737_000, 0)
	...
	fn burn() -> Weight {
		...
		//  Measured:  `980`
		//  Estimated: `8802`
		// Minimum execution time: 94_045_000 picoseconds.
		Weight::from_parts(95_177_000, 0)
			.saturating_add(Weight::from_parts(0, 8802))
	...
	fn match_swap() -> Weight {
		...
		//  Measured:  `1260`
		//  Estimated: `11406`
		// Minimum execution time: 179_224_000 picoseconds.

...
// --heap-pages=4096
// --output=/tmp/runtime/altair/src/weights/pallet_token_mux.rs
...
impl<T: frame_system::Config> pallet_token_mux::WeightInfo for WeightInfo<T> {
	...
	fn deposit() -> Weight {
		...
		//  Measured:  `803`
		//  Estimated: `8802`
		// Minimum execution time: 120_394_000 picoseconds.
		Weight::from_parts(121_507_000, 0)
	...
	fn burn() -> Weight {
		...
		//  Measured:  `1093`
		//  Estimated: `8802`
		// Minimum execution time: 103_193_000 picoseconds.
		Weight::from_parts(105_918_000, 0)
			.saturating_add(Weight::from_parts(0, 8802))
	...
	fn match_swap() -> Weight {
		...
		Weight::from_parts(212_817_000, 0)

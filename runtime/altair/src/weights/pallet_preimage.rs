...
impl<T: frame_system::Config> pallet_preimage::WeightInfo for WeightInfo<T> {
	...
	fn note_preimage(s: u32, ) -> Weight {
		...
		Weight::from_ref_time(29_000_000 as u64)
			// Standard Error: 1
			.saturating_add(Weight::from_ref_time(1_386 as u64).saturating_mul(s as u64))
	...
	fn note_requested_preimage(s: u32, ) -> Weight {
		...
		Weight::from_ref_time(19_000_000 as u64)
			// Standard Error: 1
			.saturating_add(Weight::from_ref_time(1_370 as u64).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Preimage StatusFor (r:1 w:1)
	...
	fn note_no_deposit_preimage(s: u32, ) -> Weight {
		...
		Weight::from_ref_time(19_000_000 as u64)
			// Standard Error: 1
			.saturating_add(Weight::from_ref_time(1_362 as u64).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Preimage StatusFor (r:1 w:1)

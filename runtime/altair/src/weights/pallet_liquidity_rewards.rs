...
impl<T: frame_system::Config> pallet_liquidity_rewards::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(x: u32, y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(6_671_931, 0)
			.saturating_add(Weight::from_parts(0, 1493))
			// Standard Error: 1_286
			.saturating_add(Weight::from_parts(432, 0).saturating_mul(x.into()))
			// Standard Error: 526
			.saturating_add(Weight::from_parts(1_485, 0).saturating_mul(y.into()))
			// Standard Error: 526
			.saturating_add(Weight::from_parts(4_640, 0).saturating_mul(z.into()))

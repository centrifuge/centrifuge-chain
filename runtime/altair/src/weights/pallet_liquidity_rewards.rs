...
impl<T: frame_system::Config> pallet_liquidity_rewards::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(x: u32, _y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(9_505_613, 0)
			.saturating_add(Weight::from_parts(0, 1493))
			// Standard Error: 592
			.saturating_add(Weight::from_parts(653, 0).saturating_mul(x.into()))
			// Standard Error: 242
			.saturating_add(Weight::from_parts(9_507, 0).saturating_mul(z.into()))
	...
	fn claim_reward() -> Weight {
		...
		Weight::from_parts(56_726_000, 0)
			.saturating_add(Weight::from_parts(0, 4328))

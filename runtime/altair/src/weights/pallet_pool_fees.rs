...
impl<T: frame_system::Config> pallet_pool_fees::WeightInfo for WeightInfo<T> {
	...
	fn apply_new_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(58_210_849, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 2_014
			.saturating_add(Weight::from_parts(279_465, 0).saturating_mul(n.into()))
	...
	fn remove_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(35_151_831, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 4_044
			.saturating_add(Weight::from_parts(428_154, 0).saturating_mul(n.into()))
	...
	fn charge_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(24_168_211, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 2_074
			.saturating_add(Weight::from_parts(258_865, 0).saturating_mul(n.into()))
	...
	fn uncharge_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(23_197_809, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 2_199
			.saturating_add(Weight::from_parts(259_697, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `PoolSystem::Pool` (r:1 w:0)
	...
	fn update_portfolio_valuation(n: u32, ) -> Weight {
		...
		Weight::from_parts(38_210_123, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 3_690
			.saturating_add(Weight::from_parts(3_052_827, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(2))
	}
}

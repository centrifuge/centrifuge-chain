...
impl<T: frame_system::Config> pallet_oracle_collection::WeightInfo for WeightInfo<T> {
	...
	fn propose_update_collection_info(n: u32, ) -> Weight {
		...
		Weight::from_parts(27_830_005, 0)
			.saturating_add(Weight::from_parts(0, 3693))
			// Standard Error: 5_582
			.saturating_add(Weight::from_parts(1_624_328, 0).saturating_mul(n.into()))
	...
	fn apply_update_collection_info(n: u32, ) -> Weight {
		...
		Weight::from_parts(34_582_246, 0)
			.saturating_add(Weight::from_parts(0, 9601))
			// Standard Error: 6_355
			.saturating_add(Weight::from_parts(1_674_784, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn update_collection(n: u32, m: u32, ) -> Weight {
		...
		//  Estimated: `32850 + m * (9227 ±7) + n * (9227 ±7)`
		// Minimum execution time: 245_178_000 picoseconds.
		Weight::from_parts(247_392_000, 0)
			.saturating_add(Weight::from_parts(0, 32850))
			// Standard Error: 3_127_409
			.saturating_add(Weight::from_parts(94_348_001, 0).saturating_mul(n.into()))
			// Standard Error: 3_127_409
			.saturating_add(Weight::from_parts(57_593_710, 0).saturating_mul(m.into()))

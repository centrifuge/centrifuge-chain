...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn set_lease_start() -> Weight {
		(22_303_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn set_lease_period() -> Weight {
		(22_033_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn set_contributions_root() -> Weight {
		(23_461_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn set_locked_at() -> Weight {
		(22_256_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn set_crowdloan_trie_index() -> Weight {
		(21_967_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
}

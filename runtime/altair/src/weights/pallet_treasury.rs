...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	fn propose_spend() -> Weight {
		(48_388_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
	}
	fn reject_proposal() -> Weight {
		(73_010_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	fn approve_proposal(p: u32) -> Weight {
		(17_827_000 as Weight) // Standard Error: 2_000
			.saturating_add((173_000 as Weight).saturating_mul(p as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn on_initialize_proposals(p: u32) -> Weight {
		(37_015_000 as Weight) // Standard Error: 11_000
			.saturating_add((6_747_000 as Weight).saturating_mul(p as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))

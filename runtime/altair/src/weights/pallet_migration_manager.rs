...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn migrate_system_account(n: u32) -> Weight {
		(26_510_000 as Weight) // Standard Error: 2_000
			.saturating_add((1_496_000 as Weight).saturating_mul(n as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(n as Weight)))
	}
	fn migrate_balances_issuance() -> Weight {
		(28_835_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn migrate_vesting_vesting(n: u32) -> Weight {
		(123_958_000 as Weight) // Standard Error: 279_000
			.saturating_add((52_327_000 as Weight).saturating_mul(n as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
	...
	fn migrate_proxy_proxies(n: u32) -> Weight {
		(105_125_000 as Weight) // Standard Error: 124_000
			.saturating_add((10_535_000 as Weight).saturating_mul(n as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(n as Weight)))
	}

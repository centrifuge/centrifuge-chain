...
impl<T: frame_system::Config> pallet_migration_manager::WeightInfo for WeightInfo<T> {
	...
	fn finalize() -> Weight {
		...
		Weight::from_ref_time(36_001_000 as u64)
	...
	fn migrate_system_account(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(40_469_173 as u64)
			// Standard Error: 6_508
			.saturating_add(Weight::from_ref_time(1_449_587 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	...
	fn migrate_balances_issuance() -> Weight {
		...
		Weight::from_ref_time(42_200_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Migration Status (r:1 w:1)
	...
	fn migrate_vesting_vesting(n: u32, ) -> Weight {
		// Minimum execution time: 226_403 nanoseconds.
		Weight::from_ref_time(206_948_721 as u64)
			// Standard Error: 87_565
			.saturating_add(Weight::from_ref_time(43_548_286 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	...
	fn migrate_proxy_proxies(n: u32, ) -> Weight {
		// Minimum execution time: 166_602 nanoseconds.
		Weight::from_ref_time(186_865_726 as u64)
			// Standard Error: 78_341
			.saturating_add(Weight::from_ref_time(11_037_238 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(n as u64)))
	}

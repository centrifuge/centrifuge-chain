...
impl<T: frame_system::Config> pallet_migration_manager::WeightInfo for WeightInfo<T> {
	...
	fn migrate_system_account(n: u32, ) -> Weight {
		// Minimum execution time: 17_000 nanoseconds.
		Weight::from_ref_time(16_739_301 as u64)
			// Standard Error: 1_696
			.saturating_add(Weight::from_ref_time(890_017 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	...
	fn migrate_vesting_vesting(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(78_083_231 as u64)
			// Standard Error: 336_247
			.saturating_add(Weight::from_ref_time(21_939_595 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	...
	fn migrate_proxy_proxies(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(35_309_736 as u64)
			// Standard Error: 182_085
			.saturating_add(Weight::from_ref_time(5_496_865 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(n as u64)))
	}

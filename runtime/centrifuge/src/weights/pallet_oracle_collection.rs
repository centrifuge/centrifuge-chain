...
impl<T: frame_system::Config> pallet_oracle_collection::WeightInfo for WeightInfo<T> {
	...
	fn propose_update_collection_info(n: u32, ) -> Weight {
		...
		Weight::from_parts(28_828_737, 0)
			.saturating_add(Weight::from_parts(0, 3693))
			// Standard Error: 10_990
			.saturating_add(Weight::from_parts(1_490_038, 0).saturating_mul(n.into()))
	...
	fn apply_update_collection_info(n: u32, ) -> Weight {
		...
		Weight::from_parts(35_108_166, 0)
			.saturating_add(Weight::from_parts(0, 8649))
			// Standard Error: 9_939
			.saturating_add(Weight::from_parts(1_629_487, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn update_collection(n: u32, m: u32, ) -> Weight {
		...
		Weight::from_parts(161_691_000, 0)
			.saturating_add(Weight::from_parts(0, 16920))
			// Standard Error: 21_623_789
			.saturating_add(Weight::from_parts(684_567_025, 0).saturating_mul(n.into()))
			// Standard Error: 1_071_049
			.saturating_add(Weight::from_parts(35_753_437, 0).saturating_mul(m.into()))

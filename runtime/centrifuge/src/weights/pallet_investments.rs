...
impl<T: frame_system::Config> pallet_investments::WeightInfo for WeightInfo<T> {
	...
	fn update_invest_order() -> Weight {
		...
		//  Measured:  `2053`
		//  Estimated: `6198`
		// Minimum execution time: 88_415_000 picoseconds.
		Weight::from_parts(90_449_000, 0)
	...
	fn update_redeem_order() -> Weight {
		...
		//  Measured:  `1977`
		//  Estimated: `6198`
		// Minimum execution time: 90_078_000 picoseconds.
	...
	/// Proof: `ForeignInvestments::ForeignInvestmentInfo` (`max_values`: None, `max_size`: Some(154), added: 2629, mode: `MaxEncodedLen`)
	/// The range of component `n` is `[1, 10]`.
	fn collect_investments(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2516 + n * (44 ±0)`
		//  Estimated: `6198 + n * (2555 ±0)`
		// Minimum execution time: 107_220_000 picoseconds.
		Weight::from_parts(105_180_831, 0)
			.saturating_add(Weight::from_parts(0, 6198))
			// Standard Error: 41_247
			.saturating_add(Weight::from_parts(5_538_186, 0).saturating_mul(n.into()))
	...
	/// Proof: `ForeignInvestments::ForeignRedemptionInfo` (`max_values`: None, `max_size`: Some(154), added: 2629, mode: `MaxEncodedLen`)
	/// The range of component `n` is `[1, 10]`.
	fn collect_redemptions(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2396 + n * (44 ±0)`
		//  Estimated: `6198 + n * (2555 ±0)`
		// Minimum execution time: 97_673_000 picoseconds.
		Weight::from_parts(94_544_955, 0)
			.saturating_add(Weight::from_parts(0, 6198))
			// Standard Error: 27_904
			.saturating_add(Weight::from_parts(5_217_056, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(8))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(4))
			.saturating_add(Weight::from_parts(0, 2555).saturating_mul(n.into()))

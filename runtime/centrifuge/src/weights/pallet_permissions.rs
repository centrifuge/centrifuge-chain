...
impl<T: frame_system::Config> pallet_permissions::WeightInfo for WeightInfo<T> {
	...
	fn add_as_admin() -> Weight {
		...
		//  Measured:  `3`
		//  Estimated: `5224`
		// Minimum execution time: 20_849 nanoseconds.
	...
	fn add_as_editor() -> Weight {
		...
		Weight::from_parts(29_285_000, 7927)
	...
	fn remove_as_admin() -> Weight {
		...
		Weight::from_parts(25_077_000, 5224)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: Permissions Permission (r:2 w:1)
	...
	fn remove_as_editor() -> Weight {
		...
		//  Measured:  `256`
		//  Estimated: `7927`
		// Minimum execution time: 31_278 nanoseconds.
		Weight::from_parts(31_940_000, 7927)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: Permissions Permission (r:1 w:1)
	...
	fn purge() -> Weight {
		...
		Weight::from_parts(22_192_000, 2703)
	...
	fn admin_purge() -> Weight {
		...
		Weight::from_parts(22_482_000, 2703)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

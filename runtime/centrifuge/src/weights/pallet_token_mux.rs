...
// --heap-pages=4096
// --output=/tmp/runtime/centrifuge/src/weights/pallet_token_mux.rs
...
impl<T: frame_system::Config> pallet_token_mux::WeightInfo for WeightInfo<T> {
	...
	fn deposit() -> Weight {
		...
		//  Measured:  `803`
		//  Estimated: `8802`
		// Minimum execution time: 118_732_000 picoseconds.
		Weight::from_parts(120_705_000, 0)
	...
	fn burn() -> Weight {
		...
		//  Measured:  `1093`
		//  Estimated: `8802`
		// Minimum execution time: 106_920_000 picoseconds.
		Weight::from_parts(108_193_000, 0)
			.saturating_add(Weight::from_parts(0, 8802))
	...
	fn match_swap() -> Weight {
		...
		//  Measured:  `1439`
		//  Estimated: `11406`
		// Minimum execution time: 211_274_000 picoseconds.
		Weight::from_parts(214_611_000, 0)

...
impl<T: frame_system::Config> pallet_keystore::WeightInfo for WeightInfo<T> {
	...
	fn add_keys(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(38_695_384 as u64)
			// Standard Error: 38_128
			.saturating_add(Weight::from_ref_time(26_742_823 as u64).saturating_mul(n as u64))
	...
	fn revoke_keys(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(26_934_593 as u64)
			// Standard Error: 19_158
			.saturating_add(Weight::from_ref_time(15_472_918 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(n as u64)))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(n as u64)))
	}
	...
	fn set_deposit() -> Weight {
		...
		Weight::from_ref_time(36_901_000 as u64)

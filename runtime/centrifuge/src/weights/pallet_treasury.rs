...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for WeightInfo<T> {
	...
	fn approve_proposal(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(10_633_421 as u64)
			// Standard Error: 1_784
			.saturating_add(Weight::from_ref_time(52_480 as u64).saturating_mul(p as u64))
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(18_304_547 as u64)
			// Standard Error: 14_019
			.saturating_add(Weight::from_ref_time(2_513_155 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))

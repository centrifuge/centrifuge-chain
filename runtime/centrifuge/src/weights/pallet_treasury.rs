...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for WeightInfo<T> {
	...
	fn propose_spend() -> Weight {
		...
		Weight::from_ref_time(57_501_000 as u64)
	...
	fn reject_proposal() -> Weight {
		// Minimum execution time: 80_601 nanoseconds.
	...
	fn approve_proposal(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(28_755_242 as u64)
			// Standard Error: 2_611
			.saturating_add(Weight::from_ref_time(242_266 as u64).saturating_mul(p as u64))
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		// Minimum execution time: 52_301 nanoseconds.
		Weight::from_ref_time(46_444_338 as u64)
			// Standard Error: 6_075
			.saturating_add(Weight::from_ref_time(3_999_788 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))

...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for WeightInfo<T> {
	...
	fn approve_proposal(p: u32, ) -> Weight {
		...
		Weight::from_parts(17_667_865, 0)
			.saturating_add(Weight::from_parts(0, 3573))
			// Standard Error: 1_129
			.saturating_add(Weight::from_parts(48_985, 0).saturating_mul(p.into()))
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		...
		Weight::from_parts(37_637_910, 0)
			.saturating_add(Weight::from_parts(0, 3593))
			// Standard Error: 5_873
			.saturating_add(Weight::from_parts(3_799_201, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(3))

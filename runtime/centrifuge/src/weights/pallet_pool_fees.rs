...
impl<T: frame_system::Config> pallet_pool_fees::WeightInfo for WeightInfo<T> {
	...
	fn apply_new_fee(n: u32, ) -> Weight {
		...
		//  Estimated: `17508`
		// Minimum execution time: 54_962_000 picoseconds.
		Weight::from_parts(55_423_381, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 2_061
			.saturating_add(Weight::from_parts(285_969, 0).saturating_mul(n.into()))
	...
	fn remove_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(38_425_852, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 3_944
			.saturating_add(Weight::from_parts(404_629, 0).saturating_mul(n.into()))
	...
	fn charge_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(27_469_772, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 2_019
			.saturating_add(Weight::from_parts(259_199, 0).saturating_mul(n.into()))
	...
	fn uncharge_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(26_651_227, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 2_159
			.saturating_add(Weight::from_parts(259_300, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: PoolSystem Pool (r:1 w:0)
	...
	fn update_portfolio_valuation(n: u32, ) -> Weight {
		...
		Weight::from_parts(42_835_341, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 3_863
			.saturating_add(Weight::from_parts(6_212_825, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(2))
	}
}

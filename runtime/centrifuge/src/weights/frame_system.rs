...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(5_114_197 as u64)
			// Standard Error: 0
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(13_000_000 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(1_178 as u64).saturating_mul(b as u64))
	}
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(4_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(732_900 as u64).saturating_mul(i as u64))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(4_000_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(554_101 as u64).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(7_476_958 as u64)
			// Standard Error: 3_089
			.saturating_add(Weight::from_ref_time(1_091_005 as u64).saturating_mul(p as u64))

...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn set_storage(i: u32) -> Weight {
		(0 as Weight) // Standard Error: 2_000
			.saturating_add((1_278_000 as Weight).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}

	fn kill_storage(i: u32) -> Weight {
		(0 as Weight) // Standard Error: 2_000
			.saturating_add((1_037_000 as Weight).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}

	fn kill_prefix(p: u32) -> Weight {
		(0 as Weight) // Standard Error: 4_000
			.saturating_add((2_103_000 as Weight).saturating_mul(p as u64))

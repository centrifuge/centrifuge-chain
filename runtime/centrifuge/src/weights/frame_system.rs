...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(4_027_706 as u64)
			// Standard Error: 3
			.saturating_add(Weight::from_ref_time(539 as u64).saturating_mul(b as u64))
	}
	/// The range of component `b` is `[0, 3932160]`.
	fn remark_with_event(b: u32, ) -> Weight {
		// Minimum execution time: 25_801 nanoseconds.
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(11_100_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(1_137_398 as u64).saturating_mul(i as u64))
	...
	fn kill_storage(i: u32, ) -> Weight {
		// Minimum execution time: 8_100 nanoseconds.
		Weight::from_ref_time(2_932_010 as u64)
			// Standard Error: 1_584
			.saturating_add(Weight::from_ref_time(900_465 as u64).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(11_700_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(1_734_481 as u64).saturating_mul(p as u64))

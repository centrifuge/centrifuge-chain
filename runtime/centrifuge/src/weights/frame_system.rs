...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(18_699_566 as u64)
			// Standard Error: 0
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(7_044_024 as u64)
			// Standard Error: 0
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(8_400_000 as u64)
			// Standard Error: 1_013
			.saturating_add(Weight::from_ref_time(1_145_462 as u64).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	/// The range of component `i` is `[0, 1000]`.
	fn kill_storage(i: u32, ) -> Weight {
		// Minimum execution time: 8_201 nanoseconds.
		Weight::from_ref_time(1_369_422 as u64)
			// Standard Error: 1_771
			.saturating_add(Weight::from_ref_time(912_473 as u64).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_ref_time(11_600_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(1_719_294 as u64).saturating_mul(p as u64))

...
impl<T: frame_system::Config> pallet_liquidity_rewards::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(x: u32, y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(9_828_267, 0)
			.saturating_add(Weight::from_parts(0, 1493))
			// Standard Error: 776
			.saturating_add(Weight::from_parts(2_470, 0).saturating_mul(x.into()))
			// Standard Error: 318
			.saturating_add(Weight::from_parts(731, 0).saturating_mul(y.into()))
			// Standard Error: 318
			.saturating_add(Weight::from_parts(8_782, 0).saturating_mul(z.into()))

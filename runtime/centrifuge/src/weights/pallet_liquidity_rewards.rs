...
impl<T: frame_system::Config> pallet_liquidity_rewards::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(x: u32, y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(6_799_701, 0)
			.saturating_add(Weight::from_parts(0, 1493))
			// Standard Error: 479
			.saturating_add(Weight::from_parts(1_847, 0).saturating_mul(x.into()))
			// Standard Error: 196
			.saturating_add(Weight::from_parts(814, 0).saturating_mul(y.into()))
			// Standard Error: 196
			.saturating_add(Weight::from_parts(8_156, 0).saturating_mul(z.into()))

...
impl<T: frame_system::Config> pallet_liquidity_rewards::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(x: u32, y: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(6_448_800, 0)
			.saturating_add(Weight::from_parts(0, 1493))
			// Standard Error: 1_765
			.saturating_add(Weight::from_parts(2_506, 0).saturating_mul(x.into()))
			// Standard Error: 723
			.saturating_add(Weight::from_parts(2_190, 0).saturating_mul(y.into()))
			// Standard Error: 723

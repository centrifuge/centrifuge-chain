...
impl<T: frame_system::Config> pallet_pool_registry::WeightInfo for WeightInfo<T> {
	...
	fn register(n: u32, ) -> Weight {
		// Minimum execution time: 147_003 nanoseconds.
		Weight::from_ref_time(126_507_641 as u64)
			// Standard Error: 53_902
			.saturating_add(Weight::from_ref_time(27_441_361 as u64).saturating_mul(n as u64))
	...
	fn update_no_execution(n: u32, ) -> Weight {
		// Minimum execution time: 77_602 nanoseconds.
		Weight::from_ref_time(78_517_069 as u64)
			// Standard Error: 23_582
			.saturating_add(Weight::from_ref_time(3_041_958 as u64).saturating_mul(n as u64))
	...
	fn update_and_execute(n: u32, ) -> Weight {
		// Minimum execution time: 116_102 nanoseconds.
		Weight::from_ref_time(112_049_966 as u64)
			// Standard Error: 59_704
			.saturating_add(Weight::from_ref_time(9_384_025 as u64).saturating_mul(n as u64))
	...
	fn execute_update(n: u32, ) -> Weight {
		// Minimum execution time: 102_802 nanoseconds.
		Weight::from_ref_time(98_871_774 as u64)
			// Standard Error: 68_633
			.saturating_add(Weight::from_ref_time(9_818_786 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(6 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(n as u64)))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	...
	fn set_metadata(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(45_371_985 as u64)
			// Standard Error: 9_407
			.saturating_add(Weight::from_ref_time(38_760 as u64).saturating_mul(n as u64))

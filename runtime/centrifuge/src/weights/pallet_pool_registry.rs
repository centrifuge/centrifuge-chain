...
impl<T: frame_system::Config> pallet_pool_registry::WeightInfo for WeightInfo<T> {
	...
	fn register(n: u32, m: u32, ) -> Weight {
		...
		// Minimum execution time: 247_641_000 picoseconds.
		Weight::from_parts(118_429_138, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 87_363
			.saturating_add(Weight::from_parts(27_578_189, 0).saturating_mul(m.into()))
	...
	fn update_no_execution(n: u32, m: u32, ) -> Weight {
		...
		Weight::from_parts(57_347_733, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 38_122
			.saturating_add(Weight::from_parts(3_027_421, 0).saturating_mul(n.into()))
			// Standard Error: 1_739
			.saturating_add(Weight::from_parts(219_945, 0).saturating_mul(m.into()))
	...
	fn update_and_execute(n: u32, m: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1021 + m * (124 ±0) + n * (167 ±0)`
		//  Estimated: `17508 + m * (124 ±0) + n * (2531 ±0)`
		// Minimum execution time: 117_268_000 picoseconds.
		Weight::from_parts(86_174_059, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 36_515
			.saturating_add(Weight::from_parts(9_705_978, 0).saturating_mul(n.into()))
			// Standard Error: 1_666
			.saturating_add(Weight::from_parts(242_462, 0).saturating_mul(m.into()))
	...
	fn execute_update(n: u32, m: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1009 + m * (124 ±0) + n * (194 ±0)`
		//  Estimated: `17508 + m * (124 ±0) + n * (2531 ±0)`
		// Minimum execution time: 103_112_000 picoseconds.
		Weight::from_parts(73_195_692, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 37_733
			.saturating_add(Weight::from_parts(9_825_350, 0).saturating_mul(n.into()))
			// Standard Error: 1_721
			.saturating_add(Weight::from_parts(225_401, 0).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(7))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(3))
			.saturating_add(Weight::from_parts(0, 124).saturating_mul(m.into()))
	...
	fn set_metadata(n: u32, m: u32, ) -> Weight {
		...
		Weight::from_parts(23_924_253, 0)
			.saturating_add(Weight::from_parts(0, 3693))
			// Standard Error: 714
			.saturating_add(Weight::from_parts(7_918, 0).saturating_mul(n.into()))
			// Standard Error: 332

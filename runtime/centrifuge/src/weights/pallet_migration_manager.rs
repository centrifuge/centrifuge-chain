...
impl<T: frame_system::Config> pallet_migration_manager::WeightInfo for WeightInfo<T> {
	...
	fn migrate_system_account(n: u32, ) -> Weight {
		// Minimum execution time: 17_000 nanoseconds.
		Weight::from_ref_time(16_999_664 as u64)
			// Standard Error: 2_751
			.saturating_add(Weight::from_ref_time(890_090 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	...
	fn migrate_vesting_vesting(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(42_228_184 as u64)
			// Standard Error: 111_048
			.saturating_add(Weight::from_ref_time(24_009_524 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	...
	fn migrate_proxy_proxies(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(47_510_149 as u64)
			// Standard Error: 161_275
			.saturating_add(Weight::from_ref_time(3_315_508 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(n as u64)))
	}

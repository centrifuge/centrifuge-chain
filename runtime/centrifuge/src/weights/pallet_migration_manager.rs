...
impl<T: frame_system::Config> pallet_migration_manager::WeightInfo for WeightInfo<T> {
	...
	fn finalize() -> Weight {
		// Minimum execution time: 35_799 nanoseconds.
		Weight::from_ref_time(36_500_000 as u64)
	...
	fn migrate_system_account(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(39_524_089 as u64)
			// Standard Error: 7_234
			.saturating_add(Weight::from_ref_time(1_512_020 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	...
	fn migrate_balances_issuance() -> Weight {
		...
		Weight::from_ref_time(49_201_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Migration Status (r:1 w:1)
	...
	fn migrate_vesting_vesting(n: u32, ) -> Weight {
		// Minimum execution time: 237_602 nanoseconds.
		Weight::from_ref_time(220_659_367 as u64)
			// Standard Error: 137_812
			.saturating_add(Weight::from_ref_time(45_191_108 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	...
	fn migrate_proxy_proxies(n: u32, ) -> Weight {
		// Minimum execution time: 175_001 nanoseconds.
		Weight::from_ref_time(205_704_995 as u64)
			// Standard Error: 119_696
			.saturating_add(Weight::from_ref_time(7_910_828 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(n as u64)))
	}

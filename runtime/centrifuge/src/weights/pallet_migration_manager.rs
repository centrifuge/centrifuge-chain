...
impl<T: frame_system::Config> pallet_migration_manager::WeightInfo for WeightInfo<T> {
	...
	fn migrate_system_account(n: u32, ) -> Weight {
		...
		Weight::from_parts(10_605_692, 0)
			.saturating_add(Weight::from_parts(0, 1486))
			// Standard Error: 1_429
			.saturating_add(Weight::from_parts(905_803, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	...
	fn migrate_vesting_vesting(n: u32, ) -> Weight {
		...
		Weight::from_parts(19_441_234, 0)
			.saturating_add(Weight::from_parts(0, 1486))
			// Standard Error: 30_191
			.saturating_add(Weight::from_parts(43_086_606, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	...
	fn migrate_proxy_proxies(n: u32, ) -> Weight {
		...
		Weight::from_parts(12_678_898, 0)
			.saturating_add(Weight::from_parts(0, 1486))
			// Standard Error: 6_759
			.saturating_add(Weight::from_parts(5_493_844, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}

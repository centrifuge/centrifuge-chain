...
impl<T: frame_system::Config> pallet_migration_manager::WeightInfo for WeightInfo<T> {
	...
	fn migrate_system_account(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(38_571_507 as u64)
			// Standard Error: 7_120
			.saturating_add(Weight::from_ref_time(1_473_592 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	...
	fn migrate_balances_issuance() -> Weight {
		// Minimum execution time: 40_400 nanoseconds.
	...
	fn migrate_vesting_vesting(n: u32, ) -> Weight {
		// Minimum execution time: 209_801 nanoseconds.
		Weight::from_ref_time(190_085_800 as u64)
			// Standard Error: 126_487
			.saturating_add(Weight::from_ref_time(42_500_292 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	...
	fn migrate_proxy_proxies(n: u32, ) -> Weight {
		// Minimum execution time: 155_200 nanoseconds.
		Weight::from_ref_time(170_283_142 as u64)
			// Standard Error: 106_113
			.saturating_add(Weight::from_ref_time(8_277_585 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(n as u64)))
	}

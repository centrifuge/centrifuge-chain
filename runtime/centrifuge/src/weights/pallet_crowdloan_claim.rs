...
impl<T: frame_system::Config> pallet_crowdloan_claim::WeightInfo for WeightInfo<T> {
	...
	fn claim_reward_ed25519() -> Weight {
		// Minimum execution time: 266_602 nanoseconds.
		Weight::from_ref_time(267_702_000 as u64)
	...
	fn claim_reward_sr25519() -> Weight {
		// Minimum execution time: 269_203 nanoseconds.
		Weight::from_ref_time(272_203_000 as u64)
			.saturating_add(T::DbWeight::get().reads(12 as u64))
			.saturating_add(T::DbWeight::get().writes(5 as u64))
	}
	// Storage: CrowdloanClaim CurrIndex (r:1 w:0)
	...
	fn claim_reward_ecdsa() -> Weight {
		// Minimum execution time: 248_502 nanoseconds.
		Weight::from_ref_time(251_303_000 as u64)
			.saturating_add(T::DbWeight::get().reads(12 as u64))
			.saturating_add(T::DbWeight::get().writes(5 as u64))
	}
	...
	fn set_lease_start() -> Weight {
		...
		Weight::from_ref_time(25_801_000 as u64)
	...
	fn set_contributions_root() -> Weight {
		...
		Weight::from_ref_time(27_401_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: CrowdloanClaim LockedAt (r:0 w:1)

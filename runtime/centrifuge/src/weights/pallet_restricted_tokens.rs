...
impl<T: frame_system::Config> pallet_restricted_tokens::WeightInfo for WeightInfo<T> {
	...
	fn transfer_native() -> Weight {
		// Minimum execution time: 82_100 nanoseconds.
		Weight::from_ref_time(82_900_000 as u64)
	...
	fn transfer_other() -> Weight {
		...
		Weight::from_ref_time(88_101_000 as u64)
	...
	fn transfer_keep_alive_native() -> Weight {
		...
		Weight::from_ref_time(75_501_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: OrmlTokens Accounts (r:2 w:2)
	...
	fn transfer_all_native() -> Weight {
		...
		Weight::from_ref_time(87_801_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: OrmlTokens Accounts (r:2 w:2)
	...
	fn transfer_all_other() -> Weight {
		...
		Weight::from_ref_time(92_800_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: System Account (r:1 w:1)
	fn force_transfer_native() -> Weight {
		// Minimum execution time: 81_600 nanoseconds.
		Weight::from_ref_time(82_601_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: OrmlTokens Accounts (r:2 w:2)
	...
	fn set_balance_native() -> Weight {
		...
		Weight::from_ref_time(86_501_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn set_balance_other() -> Weight {
		// Minimum execution time: 98_601 nanoseconds.
		Weight::from_ref_time(99_700_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
}

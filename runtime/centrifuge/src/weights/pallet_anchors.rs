...
impl<T: frame_system::Config> pallet_anchors::WeightInfo for WeightInfo<T> {
	...
	fn evict_pre_commits() -> Weight {
		// Minimum execution time: 1_211_000 nanoseconds.
		Weight::from_ref_time(1_220_000_000 as u64)
	...
	fn evict_anchors() -> Weight {
		// Minimum execution time: 1_325_000 nanoseconds.
		Weight::from_ref_time(1_336_000_000 as u64)

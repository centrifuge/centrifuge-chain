...
impl<T: frame_system::Config> pallet_anchors::WeightInfo for WeightInfo<T> {
	...
	fn pre_commit() -> Weight {
		// Minimum execution time: 62_502 nanoseconds.
		Weight::from_ref_time(63_402_000 as u64)
	...
	fn commit() -> Weight {
		...
		Weight::from_ref_time(96_202_000 as u64)
			.saturating_add(T::DbWeight::get().reads(7 as u64))
			.saturating_add(T::DbWeight::get().writes(5 as u64))
	}
	// Storage: Anchor PreCommits (r:100 w:100)
	fn evict_pre_commits() -> Weight {
		// Minimum execution time: 2_050_546 nanoseconds.
		Weight::from_ref_time(2_081_046_000 as u64)
	...
	fn evict_anchors() -> Weight {
		// Minimum execution time: 2_247_951 nanoseconds.
		Weight::from_ref_time(2_279_251_000 as u64)

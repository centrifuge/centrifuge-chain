...
impl<T: frame_system::Config> pallet_anchors::WeightInfo for WeightInfo<T> {
	...
	fn pre_commit() -> Weight {
		...
		Weight::from_ref_time(63_200_000 as u64)
	...
	fn commit() -> Weight {
		// Minimum execution time: 94_900 nanoseconds.
		Weight::from_ref_time(96_400_000 as u64)
			.saturating_add(T::DbWeight::get().reads(7 as u64))
			.saturating_add(T::DbWeight::get().writes(5 as u64))
	}
	// Storage: Anchor PreCommits (r:100 w:100)
	fn evict_pre_commits() -> Weight {
		// Minimum execution time: 2_006_310 nanoseconds.
		Weight::from_ref_time(2_023_710_000 as u64)
	...
	fn evict_anchors() -> Weight {
		// Minimum execution time: 2_219_611 nanoseconds.
		Weight::from_ref_time(2_256_512_000 as u64)

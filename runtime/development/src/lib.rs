...
use cfg_types::{
	...
	tokens::{
		...
		StakingCurrency::BlockRewards as BlockRewardsCurrency,
	},
};
...
use runtime_common::{
	...
	origins::gov::{
		...
		types::{
			AllOfCouncil, DispatchWhitelistedOrigin, EnsureRootOr, HalfOfCouncil, RefCancelOrigin,
			RefKillerOrigin, TreasuryApproveOrigin, TwoThirdOfCouncil, WhitelistOrigin,
		},
		PoolAdmin, Treasurer,
	},
...
pub type Executive = frame_executive::Executive<
	...
	crate::migrations::UpgradeDevelopment1505,
>;
...
construct_runtime!(
	pub enum Runtime {
		...
		Preimage: pallet_preimage::{Pallet, Call, Storage, Event<T>, HoldReason} = 72,
		...
		Tokens: pallet_restricted_tokens::{Pallet, Call, Event<T>, HoldReason} = 99,
		// Removed: NftSales = 100

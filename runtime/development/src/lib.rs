...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Nfts: pallet_nft::{Pallet, Call, Event<T>} = 101,
		Bridge: pallet_bridge::{Pallet, Call, Storage, Config<T>, Event<T>} = 102,
		InterestAccrual: pallet_interest_accrual::{Pallet, Storage, Event<T>, Config<T>} = 103,

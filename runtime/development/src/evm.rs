...
use runtime_common::{
	...
	evm::{precompile::DevelopmentPrecompiles, BaseFeeThreshold, WEIGHT_PER_GAS},
};
...
parameter_types! {
	...
	pub PrecompilesValue: DevelopmentPrecompiles<crate::Runtime> = DevelopmentPrecompiles::<_>::new();
...
impl pallet_evm::Config for crate::Runtime {
	...
	type OnCreate = ();
	type PrecompilesType = DevelopmentPrecompiles<Self>;

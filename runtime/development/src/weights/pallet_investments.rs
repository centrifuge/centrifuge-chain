...
impl<T: frame_system::Config> pallet_investments::WeightInfo for WeightInfo<T> {
	...
	fn update_invest_order() -> Weight {
		...
		Weight::from_parts(101_520_000, 0)
	...
	fn update_redeem_order() -> Weight {
		...
		//  Measured:  `2421`
		//  Estimated: `6198`
		// Minimum execution time: 99_116_000 picoseconds.
		Weight::from_parts(100_518_000, 0)
			.saturating_add(Weight::from_parts(0, 6198))
			.saturating_add(T::DbWeight::get().reads(9))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	...
	fn collect_investments(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2828 + n * (44 ±0)`
		//  Estimated: `6293 + n * (2555 ±0)`
		// Minimum execution time: 110_367_000 picoseconds.
		Weight::from_parts(105_946_000, 0)
			.saturating_add(Weight::from_parts(0, 6293))
			// Standard Error: 20_360
			.saturating_add(Weight::from_parts(5_571_103, 0).saturating_mul(n.into()))
	...
	fn collect_redemptions(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2865 + n * (44 ±0)`
		//  Estimated: `6330 + n * (2555 ±0)`
		// Minimum execution time: 111_479_000 picoseconds.
		Weight::from_parts(107_429_507, 0)
			.saturating_add(Weight::from_parts(0, 6330))
			// Standard Error: 18_573
			.saturating_add(Weight::from_parts(5_264_352, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(8))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(4))
			.saturating_add(Weight::from_parts(0, 2555).saturating_mul(n.into()))

...
impl<T: frame_system::Config> pallet_investments::WeightInfo for WeightInfo<T> {
	...
	fn update_invest_order() -> Weight {
		...
		//  Measured:  `2492`
		//  Estimated: `6198`
		// Minimum execution time: 102_833_000 picoseconds.
		Weight::from_parts(103_835_000, 0)
	...
	fn update_redeem_order() -> Weight {
		...
		//  Measured:  `2388`
		//  Estimated: `6198`
		// Minimum execution time: 101_891_000 picoseconds.
	...
	fn collect_investments(n: u32, ) -> Weight {
		...
		Weight::from_parts(109_813_564, 0)
			.saturating_add(Weight::from_parts(0, 6226))
			// Standard Error: 18_519
			.saturating_add(Weight::from_parts(5_487_634, 0).saturating_mul(n.into()))
	...
	fn collect_redemptions(n: u32, ) -> Weight {
		...
		Weight::from_parts(111_067_128, 0)
			.saturating_add(Weight::from_parts(0, 6263))
			// Standard Error: 18_276
			.saturating_add(Weight::from_parts(5_309_700, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(8))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(3))
			.saturating_add(Weight::from_parts(0, 2555).saturating_mul(n.into()))

...
impl<T: frame_system::Config> pallet_pool_system::WeightInfo for WeightInfo<T> {
	...
	fn close_epoch_no_orders(n: u32, _m: u32) -> Weight {
		...
		Weight::from_parts(54_340_730, 0)
			.saturating_add(Weight::from_parts(0, 27515))
			// Standard Error: 40_322
			.saturating_add(Weight::from_parts(78_260_878, 0).saturating_mul(n.into()))
	...
	fn close_epoch_no_execution(n: u32, _m: u32) -> Weight {
		...
		Weight::from_parts(56_960_625, 0)
			.saturating_add(Weight::from_parts(0, 27515))
			// Standard Error: 24_481
			.saturating_add(Weight::from_parts(31_890_327, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(4))
	...
	fn close_epoch_execute(n: u32, _m: u32) -> Weight {
		...
		//  Estimated: `27515 + n * (2604 ±0)`
		// Minimum execution time: 242_013_000 picoseconds.
		Weight::from_parts(165_776_025, 0)
			.saturating_add(Weight::from_parts(0, 27515))
			// Standard Error: 67_482
			.saturating_add(Weight::from_parts(79_916_715, 0).saturating_mul(n.into()))
	...
	fn submit_solution(n: u32, _m: u32) -> Weight {
		...
		Weight::from_parts(29_567_314, 0)
			.saturating_add(Weight::from_parts(0, 4278))
			// Standard Error: 6_755
			.saturating_add(Weight::from_parts(1_036_768, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: PoolSystem EpochExecution (r:1 w:1)
	...
	fn execute_epoch(n: u32, _m: u32) -> Weight {
		...
		Weight::from_parts(152_525_487, 0)
			.saturating_add(Weight::from_parts(0, 8039))
			// Standard Error: 71_034
			.saturating_add(Weight::from_parts(59_411_948, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(10))
			.saturating_add(T::DbWeight::get().reads((7_u64).saturating_mul(n.into())))

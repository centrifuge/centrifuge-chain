...
impl<T: frame_system::Config> pallet_pool_registry::WeightInfo for WeightInfo<T> {
	...
	fn register(n: u32, m: u32, ) -> Weight {
		...
		// Minimum execution time: 158_437_000 picoseconds.
		Weight::from_parts(99_784_123, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 82_159
			.saturating_add(Weight::from_parts(23_638_897, 0).saturating_mul(m.into()))
	...
	fn update_no_execution(n: u32, m: u32, ) -> Weight {
		...
		Weight::from_parts(50_552_912, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 49_048
			.saturating_add(Weight::from_parts(2_834_063, 0).saturating_mul(n.into()))
			// Standard Error: 2_238
			.saturating_add(Weight::from_parts(212_640, 0).saturating_mul(m.into()))
	...
	fn update_and_execute(n: u32, m: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1093 + m * (124 ±0) + n * (201 ±0)`
		//  Estimated: `17508 + n * (3417 ±0)`
		// Minimum execution time: 100_268_000 picoseconds.
		Weight::from_parts(68_394_134, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 61_109
			.saturating_add(Weight::from_parts(10_829_644, 0).saturating_mul(n.into()))
			// Standard Error: 2_788
			.saturating_add(Weight::from_parts(243_134, 0).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(5))
	...
	fn execute_update(n: u32, m: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1084 + m * (124 ±0) + n * (227 ±0)`
		//  Estimated: `17508 + n * (3417 ±0)`
		// Minimum execution time: 93_094_000 picoseconds.
		Weight::from_parts(62_557_228, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 52_434
			.saturating_add(Weight::from_parts(10_980_074, 0).saturating_mul(n.into()))
			// Standard Error: 2_392
			.saturating_add(Weight::from_parts(219_466, 0).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(3))
			.saturating_add(Weight::from_parts(0, 3417).saturating_mul(n.into()))
	...
	/// The range of component `m` is `[0, 100]`.
	fn set_metadata(_n: u32, m: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `146`
		//  Estimated: `3698`
		// Minimum execution time: 18_495_000 picoseconds.
		Weight::from_parts(19_656_113, 0)
			.saturating_add(Weight::from_parts(0, 3698))
			// Standard Error: 1_278
			.saturating_add(Weight::from_parts(25_028, 0).saturating_mul(m.into()))

...
impl<T: frame_system::Config> pallet_pool_registry::WeightInfo for WeightInfo<T> {
	...
	fn register(n: u32, m: u32, ) -> Weight {
		...
		// Minimum execution time: 209_801_000 picoseconds.
		Weight::from_parts(96_931_652, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 81_724
			.saturating_add(Weight::from_parts(28_411_905, 0).saturating_mul(m.into()))
	...
	fn update_no_execution(n: u32, m: u32, ) -> Weight {
		...
		Weight::from_parts(48_031_199, 0)
			.saturating_add(Weight::from_parts(0, 4278))
			// Standard Error: 17_336
			.saturating_add(Weight::from_parts(2_944_622, 0).saturating_mul(n.into()))
			// Standard Error: 791
			.saturating_add(Weight::from_parts(35_599, 0).saturating_mul(m.into()))
	...
	fn update_and_execute(n: u32, m: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1007 + n * (155 ±0)`
		//  Estimated: `6955 + n * (2531 ±0)`
		// Minimum execution time: 94_846_000 picoseconds.
		Weight::from_parts(81_495_524, 0)
			.saturating_add(Weight::from_parts(0, 6955))
			// Standard Error: 18_403
			.saturating_add(Weight::from_parts(10_556_441, 0).saturating_mul(n.into()))
			// Standard Error: 839
			.saturating_add(Weight::from_parts(55_783, 0).saturating_mul(m.into()))
	...
	fn execute_update(n: u32, m: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `997 + n * (181 ±0)`
		//  Estimated: `6945 + n * (2531 ±0)`
		// Minimum execution time: 80_760_000 picoseconds.
		Weight::from_parts(68_698_831, 0)
			.saturating_add(Weight::from_parts(0, 6945))
			// Standard Error: 29_813
			.saturating_add(Weight::from_parts(10_729_676, 0).saturating_mul(n.into()))
			// Standard Error: 1_360
			.saturating_add(Weight::from_parts(36_162, 0).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(6))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(3))
			.saturating_add(Weight::from_parts(0, 2531).saturating_mul(n.into()))
	...
	fn set_metadata(n: u32, m: u32, ) -> Weight {
		...
		Weight::from_parts(23_216_875, 0)
			.saturating_add(Weight::from_parts(0, 3693))
			// Standard Error: 753
			.saturating_add(Weight::from_parts(8_419, 0).saturating_mul(n.into()))
			// Standard Error: 350
			.saturating_add(Weight::from_parts(24_401, 0).saturating_mul(m.into()))

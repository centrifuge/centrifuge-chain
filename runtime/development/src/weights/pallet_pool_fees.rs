...
impl<T: frame_system::Config> pallet_pool_fees::WeightInfo for WeightInfo<T> {
	...
	fn propose_new_fee() -> Weight {
		...
		Weight::from_parts(35_716_000, 0)
	...
	fn apply_new_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(57_132_564, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 2_210
			.saturating_add(Weight::from_parts(289_731, 0).saturating_mul(n.into()))
	...
	fn remove_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(38_237_695, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 3_866
			.saturating_add(Weight::from_parts(410_038, 0).saturating_mul(n.into()))
	...
	fn charge_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(23_739_527, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 2_652
			.saturating_add(Weight::from_parts(282_203, 0).saturating_mul(n.into()))
	...
	fn uncharge_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(23_042_390, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 2_677
			.saturating_add(Weight::from_parts(282_152, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `PoolSystem::Pool` (r:1 w:0)
	...
	fn update_portfolio_valuation(n: u32, ) -> Weight {
		...
		Weight::from_parts(39_983_612, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 6_395
			.saturating_add(Weight::from_parts(3_012_146, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(2))
	}
}

...
impl<T: frame_system::Config> pallet_pool_fees::WeightInfo for WeightInfo<T> {
	...
	fn apply_new_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(57_282_882, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 1_865
			.saturating_add(Weight::from_parts(289_067, 0).saturating_mul(n.into()))
	...
	fn remove_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(37_186_153, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 3_901
			.saturating_add(Weight::from_parts(428_616, 0).saturating_mul(n.into()))
	...
	fn charge_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(24_164_408, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 2_222
			.saturating_add(Weight::from_parts(262_898, 0).saturating_mul(n.into()))
	...
	fn uncharge_fee(n: u32, ) -> Weight {
		...
		Weight::from_parts(23_620_971, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 2_185
			.saturating_add(Weight::from_parts(260_376, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `PoolSystem::Pool` (r:1 w:0)
	...
	fn update_portfolio_valuation(n: u32, ) -> Weight {
		...
		Weight::from_parts(39_371_621, 0)
			.saturating_add(Weight::from_parts(0, 17508))
			// Standard Error: 3_636
			.saturating_add(Weight::from_parts(2_980_612, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(2))
	}
}

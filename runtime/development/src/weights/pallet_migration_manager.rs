...
impl<T: frame_system::Config> pallet_migration_manager::WeightInfo for WeightInfo<T> {
	...
	fn finalize() -> Weight {
		...
		Weight::from_parts(10_000_000, 496)
	...
	fn migrate_system_account(n: u32, ) -> Weight {
		...
		//  Estimated: `496`
		// Minimum execution time: 10_000 nanoseconds.
		Weight::from_parts(9_270_130, 496)
			// Standard Error: 1_405
			.saturating_add(Weight::from_ref_time(826_266).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	...
	fn migrate_balances_issuance() -> Weight {
		...
		//  Estimated: `496`
		// Minimum execution time: 10_000 nanoseconds.
		Weight::from_parts(11_000_000, 496)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: Migration Status (r:1 w:1)
	...
	fn migrate_vesting_vesting(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `396 + n * (461 ±0)`
		//  Estimated: `496 + n * (9909 ±0)`
		// Minimum execution time: 37_000 nanoseconds.
		Weight::from_parts(23_565_350, 496)
			// Standard Error: 142_196
			.saturating_add(Weight::from_ref_time(22_365_069).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	...
	fn migrate_proxy_proxies(n: u32, ) -> Weight {
		...
		Weight::from_parts(15_181_712, 496)
			// Standard Error: 32_631
			.saturating_add(Weight::from_ref_time(4_722_368).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
	}

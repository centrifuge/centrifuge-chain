...
impl<T: frame_system::Config> pallet_keystore::WeightInfo for WeightInfo<T> {
	...
	fn add_keys(n: u32, ) -> Weight {
		...
		Weight::from_parts(16_926_925, 0)
			.saturating_add(Weight::from_parts(0, 3593))
			// Standard Error: 10_899
			.saturating_add(Weight::from_parts(27_767_673, 0).saturating_mul(n.into()))
	...
	fn revoke_keys(n: u32, ) -> Weight {
		...
		Weight::from_parts(8_829_942, 0)
			.saturating_add(Weight::from_parts(0, 990))
			// Standard Error: 16_913
			.saturating_add(Weight::from_parts(13_295_862, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
			.saturating_add(Weight::from_parts(0, 2595).saturating_mul(n.into()))
	}

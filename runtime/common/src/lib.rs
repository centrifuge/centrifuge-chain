...
pub mod reexport {
	pub mod pallets {
		pub use axelar_gateway_precompile;
		pub use chainbridge;
		...
		pub use pallet_anchors;
		pub use pallet_aura;
		pub use pallet_authorship;
		pub use pallet_balances;
		pub use pallet_base_fee;
		pub use pallet_block_rewards;
		pub use pallet_bridge;
		pub use pallet_claims;
		pub use pallet_collator_allowlist;
		pub use pallet_collator_selection;
		pub use pallet_collective;
		pub use pallet_crowdloan_claim;
		pub use pallet_crowdloan_reward;
		pub use pallet_data_collector;
		pub use pallet_democracy;
		pub use pallet_elections_phragmen;
		pub use pallet_ethereum;
		pub use pallet_ethereum_transaction;
		pub use pallet_evm;
		pub use pallet_evm_chain_id;
		pub use pallet_fees;
		pub use pallet_foreign_investments;
		pub use pallet_identity;
		pub use pallet_interest_accrual;
		pub use pallet_investments;
		pub use pallet_keystore;
		pub use pallet_liquidity_pools;
		pub use pallet_liquidity_pools_gateway;
		pub use pallet_liquidity_rewards;
		pub use pallet_loans;
		pub use pallet_membership;
		pub use pallet_migration_manager;
		pub use pallet_multisig;
		pub use pallet_nft;
		pub use pallet_nft_sales;
		pub use pallet_order_book;
		pub use pallet_permissions;
		pub use pallet_pool_registry;
		pub use pallet_pool_system;
		pub use pallet_preimage;
		pub use pallet_proxy;
		pub use pallet_restricted_tokens;

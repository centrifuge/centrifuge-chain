...
/// All needed contracts can be loaded from here
pub const AXELAR_SOL_SOURCES: &str = env!("AXELAR_SOL_SOURCES", "Build script failed to populate environment variable AXELAR_SOL_SOURCES pointing to solidity source files.");

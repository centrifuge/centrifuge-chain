...
/// Centrifuge Vault Solidity artifacts generated by build-script.
...
1. Pulled the 'vaults-internal' submodule via

	git submodule update --init --recursive
	git submodule update --remote runtime/integration-tests/submodules/vaults-internal

...
fn add_pool() {
	...
	Development::execute_with(|| {
		...
		assert_ok!(OrmlAssetRegistry::register_asset(
			RuntimeOrigin::root(),
			meta,
			Some(CurrencyId::ForeignAsset(asset_id))
		));
...
fn encoded_ethereum_xcm_add_pool() {
	...
	let expected_encoded_hex = "";

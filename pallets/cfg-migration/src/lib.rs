...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn migrate(
            ...
            T::Tokens::transfer(T::NativeCfg::get(), &who, &cfg_lock_account, cfg_amount, Preservation::Expendable)?;
            T::Tokens::mint_into(iou, &cfg_lock_account , cfg_amount)?;

            pallet_liquidity_pools::Pallet::<T>::transfer(OriginFor::<T>::signed(cfg_lock_account), T::IouCfg::get(), DomainAddress::Evm(T::EVMChainId::get(), receiver), cfg_amount)?;

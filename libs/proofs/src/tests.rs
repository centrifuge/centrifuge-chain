...
fn bundled_hash_with_leaves() {
	let proofs: Vec<H256> = vec![
		[
			103, 46, 60, 60, 148, 2, 8, 108, 29, 15, 111, 98, 88, 90, 56, 3, 57, 124, 5, 25, 100,
			82, 231, 99, 186, 115, 165, 102, 22, 245, 83, 147,
		]
		.into(),
		[
			112, 102, 224, 155, 227, 136, 160, 106, 127, 252, 25, 95, 234, 206, 155, 3, 237, 180,
			242, 172, 240, 225, 85, 46, 125, 73, 42, 225, 214, 242, 239, 184,
		]
		.into(),
		[
			131, 137, 170, 250, 176, 243, 90, 79, 242, 135, 64, 183, 249, 106, 200, 177, 96, 105,
			70, 38, 50, 221, 139, 175, 247, 161, 201, 31, 71, 169, 101, 114,
		]
		.into(),
		[
			181, 110, 49, 204, 113, 201, 241, 253, 213, 177, 124, 217, 157, 68, 43, 8, 157, 127,
			218, 194, 90, 40, 153, 33, 125, 155, 10, 73, 20, 173, 89, 193,
		]
		.into(),
	];
	...
	let res: H256 = [
		92, 231, 93, 51, 106, 224, 159, 91, 206, 250, 124, 26, 16, 236, 141, 56, 42, 126, 225, 64,
		28, 191, 37, 51, 131, 63, 224, 233, 24, 207, 211, 182,
	]
	.into();

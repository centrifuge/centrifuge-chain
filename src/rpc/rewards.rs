...
pub trait RewardsApi<AccountId, Balance, RewardDomain, CurrencyId, BlockHash> {
    ...
    fn list_currencies(&self, account_id: AccountId, at: Option<BlockHash>,) -> RpcResult<Vec<(RewardDomain, CurrencyId)>>;
...
{
    fn list_currencies(&self, account_id: AccountId, at: Option<Block::Hash>) -> RpcResult<Vec<(RewardDomain, CurrencyId)>> {
